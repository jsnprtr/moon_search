...
test(`It should create a card object with no link text`, () => {
  ...
  expect(cardHtml.outerHTML).toMatch("<div class=\"ui card Rick\" data-datetime=\"1459965360\"><div class=\"content\"><b>Time (day, hour, minute, second): </b>00 01 02 03<br><b>Time (UTC): </b>Oct 21, 2015, 7:28:00 AM<br><b>Rick: </b>If I die in a <em>cage</em> I lose a bet</div></div>");
});